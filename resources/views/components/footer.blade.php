<footer class="footer mt-10 p-10 bg-base-300 text-base-content">
    <nav>
        ...
        <a href="{{ url('/#what-we-do') }}" class="link link-hover">What We Do</a>
        <a href="{{ url('/#who-we-are') }}" class="link link-hover">Who We Are</a>
        <a href="{{ url('/#how-we-do-it') }}" class="link link-hover">How We Do It</a>
        <a href="{{ url('/news') }}" class="link link-hover">News & Views</a>
        <a href="{{ url('/people') }}" class="link link-hover">Our People & Values</a>
    </nav>
    <nav>
        <h6 class="footer-title">Location</h6>
        <p>Laboratorium Mikroprosessor</p>
        <p>Gedung A8 Lantai 4 Ruang 11</p>
        <p>Universitas Negeri Surabaya</p>
        <p>Jl. Ketintang, Ketintang, Kec. Gayungan, Surabaya, Jawa Timur 60231</p>
    </nav>
    <nav>
        <h6 class="footer-title">Social</h6>
        <div class="grid grid-flow-col gap-4">
        <a href="https://www.linkedin.com/company/microprosessor-laboratory-unesa/" target="_blank">
        ...
        <a href="https://www.instagram.com/ilabs_unesa" target="_blank">
            <svg width="32px" height="32px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
